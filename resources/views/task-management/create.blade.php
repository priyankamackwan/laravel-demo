                        ...
                        <form action="{{route('task.store')}}" method="post">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><input type='text' name='title' id='title' placeholder="Title"class="form-control" autocomplete="off"></td>
                                    @if ($errors->has('title'))
                                ...
                                <tr>
                                    ...
                                    <td><input type='text' name='description' id='description' placeholder="Company Name" class="form-control"></td>
                                    @if ($errors->has('description'))
                                        <span class="text-danger">{{ $errors->first('description') }}</span>
                                    @endif
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name='estimate_hours' class="form-control bs-timepicker"></td>
